...
html, body {
	...
	height: 100%;
	display: flex;
	background-image: url(assignplanner.jfif);
				...
				<div class="row">
					<div class="col-md-4">
						<form name="AssignmentForm" action="AssignmentController"
							...
							<div class="input-box">
								<label for="subject_Name">Subject:</label><br>${assignment.subject_Name}<input
									type="hidden" name="subjectCode" value="${assignment.subject_Name}" />
							</div>
							<div class="input-box">
								<label for="title">Assignment Name:</label><br> <input
									type="text" class="form-control" name="title"
									placeholder="Enter assignment name" readonly value="${assignment.title}" />
							</div>
							<div class="textarea">
							...
							<div class="input-box">
								<label for="lect_name">Lecturer Name:</label><br>${lecturerName}<input
									type="hidden" name="lecturerName" value="${lecturerName}" />
							</div>
							<div class="select-box">
								<label for="status">Status:${assignment.status}</label><br> <select
